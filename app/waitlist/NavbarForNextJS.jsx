...
const NavbarForNextJS = () => {
  ...
  // Navigation function for Next.js
        ...
        <div className="flex items-center justify-between h-14 sm:h-16 lg:h-18">
          ...
          <div className="hidden md:flex flex-1 justify-center">
            <nav className="flex items-center space-x-2 sm:space-x-4 lg:space-x-8">
              ...
              <div>
                <button
                  onClick={() => navigateToPage("/waitlist")}
                  className="relative px-2 sm:px-3 lg:px-4 py-2 lg:py-2.5 rounded-lg font-medium text-xs sm:text-sm transition-all duration-300 group whitespace-nowrap text-white bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30 shadow-lg shadow-blue-500/20"
                >
            ...
            >
              ...
              >
                ...
                <motion.div className="space-y-2" variants={menuVariants}>
                  {navLinks.map((link, index) =>
                    link.disabled ? (
                      ...
                      <motion.button
                        ...
                        className={`block px-4 py-4 rounded-2xl font-medium transition-all duration-300 group w-full text-left ${
                          activeSection === link.section
                            ? "text-white bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30 shadow-lg shadow-blue-500/20"
                  ...
                  {/* Add Waitlist link to mobile menu */}
                  <motion.button
                    onClick={() => {
                      navigateToPage("/waitlist");
                      setMenuOpen(false);
                    }}
                    className="block px-4 py-4 rounded-2xl font-medium transition-all duration-300 group w-full text-left text-white bg-gradient-to-r from-blue-500/20 to-cyan-500/20 border border-blue-400/30 shadow-lg shadow-blue-500/20"
                    variants={menuItemVariants}
                    whileHover={{
                      scale: 1.02,
                      x: 5,
...
export default NavbarForNextJS;
