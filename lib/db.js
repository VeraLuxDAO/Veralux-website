...
export async function addToWaitlist(userData) {
  ...
  try {
    const { discordUsername, twitterUsername, email, walletAddress } = userData;
    ...
    const result = await sql`
      INSERT INTO waitlist (discord_username, twitter_username, email, wallet_address)
      VALUES (${discordUsername}, ${twitterUsername}, ${email}, ${walletAddress})
      RETURNING id, discord_username, twitter_username, email, wallet_address, created_at;
    `;
