...
const Waitlist = () => {
  ...
  const handleDiscordClick = () => {
    ...
    // Mark that user has clicked to join Discord and save to localStorage
    setHasJoinedDiscord(true);
    localStorage.setItem("veralux_discord_joined", "true");
  };
  ...
  const handleContinue = () => {
    ...
    navigate("/"); // Navigate to landing page (About page)
  };
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-8">
            ...
            >
                ...
                {isStepAccessible(1) && !hasJoinedDiscord && (
                  <div className="flex flex-col gap-3 sm:flex-row sm:gap-4 sm:items-center">
                    <button
                      ...
                      className="bg-[#5865F2] hover:bg-[#4752C4] px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg font-semibold transition-all duration-200 text-sm sm:text-base transform hover:scale-105 shadow-lg"
                    >
                      Join Discord
                    </button>
                  </div>
              ...
              {/* Show input field only after joining or if already joined */}
              {isStepAccessible(1) && hasJoinedDiscord && (
                <motion.div
                  className="mt-4"
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <span>
                          Great! Now enter your Discord username to proceed
                        </span>
                      </div>
                      <button
                        type="button"
                    ...
                    <input
                      type="text"
                      placeholder="Enter your Discord username (without @)"
              ...
              {/* Show hint if step is accessible but not joined yet */}
              {isStepAccessible(1) && !hasJoinedDiscord && (
                <div className="mt-4 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <p className="text-sm text-blue-300">
                    <FaDiscord className="inline w-4 h-4 mr-2" />
                    Click "Join Discord" to open our server, then return here to
                    enter your username
                  </p>
                </div>
              )}
